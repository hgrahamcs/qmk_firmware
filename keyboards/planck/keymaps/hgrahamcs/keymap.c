...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_LT, KC_RT,  _______,
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    DEBUG, _______, _______, _______, _______, _______, _______, _______, QWERTY, DVORAK, PLOVER, _______
)
